...
<div class="container">
    ...
    <form:form action="/admin/blogs/updateP" method="post" commandName="blogP" role="form">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="title" placeholder="输入标题:" value="${blog.title}"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="content" name="content" rows="3"
                      placeholder="输入内容">${blog.content}</textarea>
        </div>
        <div class="form-group">
            <label for="pubDate">发表日期:</label>
